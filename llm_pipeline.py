...
GRAPH_EVIDENCE_PROMPT_APPEND = (
    ...
    "- MANDATORY: If vertical or horizontal guide lines (often dashed or colored) intersect on the curve, you MUST extract that intersection as a KEY_POINT.\n"
    "- Rule: The guide lines themselves are the evidence. Do not require a drawn 'dot' or 'point' marker.\n"
    "- Example: A line from x=5 and a line from y=13 intersecting on the curve = (5, 13).\n"
